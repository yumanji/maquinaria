...
public class AgriaffairesCompleto2 {
  ...
  @Test
  public void testAgriaffairesCompleto2() throws Exception {
    driver.get(baseUrl + "/");
    driver.findElement(By.id("902")).click();
    driver.findElement(By.id("903")).click();
    driver.findElement(By.id("904")).click();
    driver.findElement(By.id("907")).click();
    driver.findElement(By.id("904")).click();
    driver.findElement(By.cssSelector("#listeRub > ul.pac_RubMere > li > ul.pac_RubFille > li > a")).click();
