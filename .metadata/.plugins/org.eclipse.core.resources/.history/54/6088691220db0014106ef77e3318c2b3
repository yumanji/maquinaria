				...
				if(listaEnlacesSubcategoria.size() == 0) {
					...
					while (itListaEnlacesSubcategoria.hasNext()) {
						...
						if(listaEnlacesSubSubcategoria.size() == 0) {
							...
							registerArticles(listaEnlacesArticulos, urlEnlace2);
							...
							while (itListaEnlacesSubSubcategoria.hasNext()) {
								...
								// Grabo la información de la categoría de análisis
								urlEnlace3.grabar();
								List<String> listaEnlacesArticulos = getArticleLinks(urlEnlace3.getCategory_url());
								System.out.println("Encontrados ".concat(String.valueOf(listaEnlacesArticulos.size())).concat(" articulos en el enlace ").concat(urlEnlace3.getCategory_url()));
								registerArticles(listaEnlacesArticulos, urlEnlace3);
							}
						}
					}
				}
